...
const riddlesData = [
  {
    question:
      "I speak without a mouth and hear without ears. I have no body, but I come alive with the wind. What am I? I speak without a mouth and hear without ears. I have no body, but I come alive with the wind. What am I? ",
    answer: "xyz",
  },
  {
    question:
      ...
      <div className="mt-5 flex flex-col md:flex-row justify-between p-6 m-auto top-0 left-0 z-0 ">
        ...
        <div className="flex flex-row md:flex-col text-lg md:text-2xl space-x-3">
          <p className="font-semibold  text-green-500 flex flex-row space-x-2">
            Answered: <span className="text-white flex-row pl-2">5/5</span>{" "}
          </p>
          <p className="font-semibold  text-green-500 flex flex-row">
            Your Score: <span className="text-white flex-row ">2500</span>
          </p>
        </div>
      </div>
