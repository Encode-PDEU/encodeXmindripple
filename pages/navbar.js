            ...
            <div className={`fixed top-0 right-0 h-full bg-black w-full bg-opacity-20 backdrop-blur-md z-30 transform transition-transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className={`md:flex md:flex-row md:text-center text-center items-center md:items-center ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className="md:flex md:items-center mt-20 md:flex-row md:justify-center md:gap-x-8 p-20">
                        <Link href="/riddles">
                            <div className={`link-style pb-6 mt-10 text-2xl ${router.pathname === '/riddles' ? 'text-green-500' : 'text-yellow-500'}`}>
                                Riddles
                            </div>
                        </Link>

                        <Link href="/leaderboard_laptop">
                            <div className={`link-style pb-6 text-2xl ${router.pathname === '/leaderboard_laptop' ? 'text-green-500' : 'text-yellow-500'}`}>
                                Leaderboard
                            </div>
                        </Link>

                        <Link href="/more">
                            <div className={`link-style text-2xl ${router.pathname === '/more' ? 'text-green-500' : 'text-yellow-500'}`}>
                                More
                            </div>
                        </Link>
                    </div>
            ...
            <div className="flex-1">
                <div className="flex items-center justify-between p-6">
                    ...
                    <div className={`md:flex md:items-center md:flex-row md:justify-center md:gap-x-8 md:ml-28  ${isMenuOpen ? 'hidden' : 'hidden'}`}>
                        <Link href="/riddles">
                            <div className={`link-style text-2xl ${router.pathname === '/riddles' ? 'text-green-500' : 'text-yellow-500'}`}>
                                Riddles
                            </div>
                        </Link>

                        <Link href="/leaderboard_laptop">
                            <div className={`link-style text-2xl ${router.pathname === '/leaderboard_laptop' ? 'text-green-500' : 'text-yellow-500'}`}>
                                Leaderboard
                            </div>
                        </Link>
                    ...
                    <div className={`md:flex md:flex-row flex flex-row md:pl-8 ${isMenuOpen ? 'hidden' : 'hidden'}`}>
                        <button className="md:border md:border-yellow-500 text-yellow-500 md:px-4 md:py-2 items-center text-center rounded-lg text-2xl ">
                            Logout
                        </button>
                    </div>
                </div>
